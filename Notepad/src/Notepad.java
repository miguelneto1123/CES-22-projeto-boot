...
public class Notepad extends JFrame implements ActionListener {
	 ...
	 * abrir a tela com "CES-22". O 0,0 Ã© o tamanho da Ã¡rea de texto. NÃ£o
	...
	private MenuItem close = new MenuItem(); // opÃ§Ã£o fechar
	
	public Notepad(){
		this.setSize(600, 800); // tamanho inicial da tela
		this.setTitle("Projeto Boot CES-22"); // tÃ­tulo da tela
		setDefaultCloseOperation(EXIT_ON_CLOSE); // fecha a aplicaÃ§Ã£o
		...
		this.getContentPane().add(textArea); // adiciona a Ã¡rea de texto
		// ao painel da aplicaÃ§Ã£o
		
		this.setMenuBar(this.menuBar);
		this.menuBar.add(this.file); // criaÃ§Ã£o da barra de menus
		...
		// adiciona Ã  aba Arquivo
		
		//--------- BotÃ£o de salvar arquivo
